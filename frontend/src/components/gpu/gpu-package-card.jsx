...
export function GpuPackageCard({ gpuPackage }) {
  ...
  return (
    <Card interactive className="gpu-market-card flex h-full flex-col">
      <div className="gpu-market-card-summary">
        <p>{gpuPackage.name}</p>
      </div>
      <div className="gpu-market-card-details">
        <CardHeader
        ...
        <CardContent className="flex flex-1 flex-col gap-4">
          ...
          <div className="gpu-market-card-pricing mt-auto grid grid-cols-2 gap-3 rounded-button border border-white/10 bg-white/[0.055] p-4">
            <div>
